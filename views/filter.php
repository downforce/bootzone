...
?>
        ...
        <div id="contentButtons">
          <input type="submit" class="btn btn-small btn-primary" value="<?= $SLANG['Submit'] ?>" onclick="submitToEvents( this );"/>
...
<?php if ( canEdit( 'Events' ) ) { ?>
          <input type="button" class="btn btn-small btn-primary" value="<?= $SLANG['Save'] ?>" onclick="saveFilter( this );"/><?php } ?>
<?php if ( canEdit( 'Events' ) && isset($dbFilter) ) { ?>
          <input type="button" class="btn btn-small btn-primary" value="<?= $SLANG['Delete'] ?>" onclick="deleteFilter( this, '<?= $dbFilter['Name'] ?>' );"/><?php } ?>
          <input type="button" class="btn btn-small btn-primary" value="<?= $SLANG['Reset'] ?>" onclick="submitToFilter( this, 1 );"/>
        </div>
      </form>
    </div>
  </div>
