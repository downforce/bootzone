...
?>
        ...
        <div id="contentButtons">
          <input type="button" class="btn btn-small btn-primary" value="<?= $SLANG['AddNewControl'] ?>" onclick="createPopup( '?view=controlcap', 'zmControlCap', 'controlcap' );"<?php if ( !canEdit( 'Control' ) ) {?> disabled="disabled"<?php } ?>/><input type="submit" class="btn btn-small btn-danger" name="deleteBtn" class="btn btn-small btn-danger" value="<?= $SLANG['Delete'] ?>" disabled="disabled"/>
        </div>
      </form>
    </div>
  </div>
