    ...
    <div id="content" class="row-fluid">
      <form name="contentForm" id="contentForm" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
        ...
        <div id="contentButtons">
          <input type="submit" class="btn btn-small btn-success" name="saveBtn" value="<?= $SLANG['Save'] ?>" onclick="submitPreset( this )" disabled="disabled"/><input type="button" class="btn btn-small btn-inverse" value="<?= $SLANG['Cancel'] ?>" onclick="closeWindow()"/>
        </div>
      </form>
    </div>
  </div>
