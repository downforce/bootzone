...
?>
        ...
        <div id="contentButtons">
          <input type="submit" class="btn btn-small btn-success" value="<?= $SLANG['Apply'] ?>"/>
          <input type="button" class="btn btn-small btn-primary" value="<?= $SLANG['New'] ?>" onclick="newGroup()"<?= canEdit('System')?'':' disabled="disabled"' ?>/>
          <input type="button" class="btn btn-small btn-primary" name="editBtn" value="<?= $SLANG['Edit'] ?>" onclick="editGroup( this )"<?= $selected&&canEdit('System')?'':' disabled="disabled"' ?>/>
          <input type="button" class="btn btn-small btn-danger" name="deleteBtn" value="<?= $SLANG['Delete'] ?>" onclick="deleteGroup( this )"<?= $selected&&canEdit('System')?'':' disabled="disabled"' ?>/>
