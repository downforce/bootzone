...
<body>
  <div class="container-fluid">
    <div class="row-fluid">
      <h3><?= $SLANG['ControlCap'] ?> - <?= $newControl['Name'] ?></h3>
    </div>
    <div id="content" class="row-fluid" class="row-fluid">
      <ul class="tabList">
<?php
...
?>
        ...
        <div id="contentButtons">
          <input type="submit" class="btn btn-small btn-success" value="<?= $SLANG['Save'] ?>"<?php if ( !canEdit( 'Control' ) ) { ?> disabled="disabled"<?php } ?>/><input type="button" class="btn btn-small btn-inverse" value="<?= $SLANG['Cancel'] ?>" onclick="closeWindow()"/>
        </div>
      </form>
    </div>
  </div>
