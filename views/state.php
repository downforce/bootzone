...
?>
        ...
        <div id="contentButtons">
          <input type="submit" class="btn btn-small btn-primary" value="<?= $SLANG['Apply'] ?>"/>
          <input type="button" class="btn btn-small btn-success"  name="saveBtn" value="<?= $SLANG['Save'] ?>" disabled="disabled" onclick="saveState( this );"/>
          <input type="button" class="btn btn-small btn-delete"  name="deleteBtn" value="<?= $SLANG['Delete'] ?>" disabled="disabled" onclick="deleteState( this );"/>
