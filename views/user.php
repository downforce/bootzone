...
<body>
  <div class="container-fluid">
    <div class="row-fluid">
      <h3><?= $SLANG['User']." - ".$newUser['Username'] ?></h3>
    </div>
...
?>
        ...
        <div id="contentButtons">
          <input type="submit" class="btn btn-small btn-primary" value="<?= $SLANG['Save'] ?>"/><input type="button" class="btn btn-small btn-inverse" value="<?= $SLANG['Cancel'] ?>" onclick="closeWindow()"/>
        </div>
      </form>
    </div>
  </div>
